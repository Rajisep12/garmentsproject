...
from App.custom_views import admin,admin_methods, balancesheet
...
urlpatterns = [
    ...
    path("admin/customer/<int:customer_id>/balance-sheet/", balancesheet.customer_balance_sheet, name="customer-balance-sheet"),
